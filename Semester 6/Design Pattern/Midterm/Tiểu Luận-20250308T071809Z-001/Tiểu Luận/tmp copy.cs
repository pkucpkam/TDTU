...
namespace Chapter.Observer
{
    public class BikeController : Subject
    {
        ...
        private IShieldBehaviour _shieldBehaviour = new BasicShield();

        public void SetShieldBehaviour(IShieldBehaviour shieldBehaviour)
        {
            _shieldBehaviour = shieldBehaviour;
        }

        public void TakeDamage(float amount)
        {
            amount = _shieldBehaviour.AbsorbDamage(amount);
            health -= amount;
            NotifyObservers();
        }
...
namespace Chapter.Command
{
    public class HealCommand : Command
    {
        ...
        public HealCommand(BikeController controller, float healAmount)
        {
            _controller = controller;
...
namespace Chapter.Strategy
{
    ...
    public class ReflectiveShield : IShieldBehaviour
    {
        public float AbsorbDamage(float damage)
        {
...
namespace Chapter.Command
{
    public class JumpCommand : Command
    {
        ...
        public JumpCommand(BikeController controller)
        {
            _controller = controller;
        }
