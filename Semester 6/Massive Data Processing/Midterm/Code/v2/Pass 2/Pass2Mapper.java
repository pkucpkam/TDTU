...
// Pass2Mapper.java
public class Pass2Mapper extends Mapper<LongWritable, Text, Text, Text> { // Changed IntWritable to Text
    ...
    protected void map(LongWritable key, Text value, Context context)
        ...
        if (frequentCustomers.contains(customer)) {
            context.write(new Text(date), new Text(customer)); // Output <date, customer_id>
        }
    }
}