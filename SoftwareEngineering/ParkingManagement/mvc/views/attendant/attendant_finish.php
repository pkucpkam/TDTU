            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Return the vehicle</h1>
                    </div>

                    <!-- Content -->
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <h6 class="m-0 font-weight-bold text-primary">Vehicle return information</h6>
                        </div>
                        ...
                        <div class="card-body">
                            <form id="finish">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="ticketCode" placeholder="Enter the ticket code">
                                </div>
                                <!-- Nút Trả xe -->
    ...
    <script>
        $(document).ready(function () {
            $('#finish').submit(function (e) {
                ...
                var cardID = $('#ticketCode').val();
                var functionName = 'finish';
