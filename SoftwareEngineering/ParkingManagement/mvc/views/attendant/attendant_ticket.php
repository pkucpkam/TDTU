            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Print Ticket</h1>
                    </div>

                    <!-- Form ticket -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Fill in the information to print the bus ticket</h6>
                        </div>
                        <div class="card-body">
                            <form id="parkingForm">
                                <div class="form-group">
                                    <label for="parkingArea">Area:</label>
                                    <select class="form-control" id="parkingArea">
                                ...
                                <div class="form-group">
                                    <label for="licensePlate">License plates:</label>
                                    <input type="text" class="form-control" id="licensePlate" required>
                                </div>
                                <button type="submit" class="btn btn-primary float-right">Print ticket</button>
                            </form>
                        </div>
                    </div>
