            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Report problem </h1>
                    </div>

                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <!-- Form nhập nội dung khiếu nại -->
                            <form>
                                <div class="form-group">
                                    <label class="mb-3 font-weight-bold text-primary" for="complaint">Content reports:</label>
                                    <textarea class="form-control" id="complaint" rows="3" required></textarea>
                                </div>
                                <!-- Nút gửi -->
                                <button type="submit" class="btn btn-primary float-right" >Send report</button>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('form').submit(function (e) {
                ...
                var typeReport = "Notify";

                // Send the report using AJAX
                $.ajax({
                    type: 'POST',
                    url: '../../controllers/reportController1.php', // Replace with your PHP file handling the report
                    data: { complaint: complaint, typeReport: typeReport, submitReport: 1 },
